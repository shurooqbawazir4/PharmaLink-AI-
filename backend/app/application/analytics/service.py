...
docs/architecture.md). Milestone B computes only what's derivable without
ML; forecast accuracy / CO2 reduction / patient impact wait for
Milestone C's real numbers.
"""
